...
using PassengerMicroservice.DataAccess;
...
namespace PassengerMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PassengerMicroserviceContext>(options =>
                options.UseInMemoryDatabase(databaseName: "passengerMicroservice"));
